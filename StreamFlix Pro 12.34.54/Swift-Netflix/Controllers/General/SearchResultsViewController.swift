    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovieWithQuery(with: titleName) { [weak self] result in
            ...
            case .success(let videoElement):
                self?.delegate?.searchResultsViewControllerDidItemTap(TitlePreviewViewModel(id: title.id,                              titleLabel: titleName, overViewLabel: overview, youtubeView: videoElement, posterPath: ""))
